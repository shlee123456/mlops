...
- gmr_fastapi_server: 회사 내 프로덕션 레벨 FastAPI 서버
  - 설정 패턴: `fastapi/core/config.py`
  - DB 모델: `fastapi/models/models.py`
  - 라우터 구조: `fastapi/routers/router.py`
  - DB 연결: `fastapi/database.py`
